...
public class Metrics {
     ...
     *
     * @param javaPlugin Plugin Java
     * @param serviceId  The id of the service. It can be found at <a
     *                   href="https://bstats.org/what-is-my-plugin-id">What is my plugin id?</a>
     */
    public Metrics(Plugin javaPlugin, int serviceId) {
        ...
        metricsBase =
                new MetricsBase(
                        ...
                        submitDataTask -> plugin.getServer().getGlobalRegionScheduler().execute(javaPlugin, submitDataTask),
                        plugin::isEnabled,
