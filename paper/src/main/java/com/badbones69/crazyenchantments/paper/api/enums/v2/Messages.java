...
public enum Messages {
    ...
    TINKER_SOLD_MESSAGE("Tinker-Sold-Msg", "<gray>Thank you for trading at <gray><b>The <dark_red><b>Crazy <red><b>Tinkerer<gray>."),
    ...
    GIVE_SCRAMBLER_CRYSTAL("Give-Scrambler-Crystal", "<gray>You have given {player} {amount} <yellow><b>Grand Scramblers<gray>."),
    GET_SCRAMBLER("Get-Scrambler-Crystal", "<gray>You have gained {amount} <yellow><b>Grand Scramblers<gray>."),
    ...
    RAGE_BUILDING("Rage.Building", "<gray>[<red><b>Rage<gray>]: <green>Keep it up, your rage is building."),
    RAGE_COOLED_DOWN("Rage.Cooled-Down", "<gray>[<red><b>Rage<gray>]: <red>Your Rage has just cooled down."),
    RAGE_RAGE_UP("Rage.Rage-Up", "<gray>[<red><b>Rage<gray>]: <gray>You are now doing <green>{level}x <gray>Damage."),
    RAGE_DAMAGED("Rage.Damaged", "<gray>[<red><b>Rage<gray>]: <red>You have been hurt and it broke your Rage Multiplier!"),
