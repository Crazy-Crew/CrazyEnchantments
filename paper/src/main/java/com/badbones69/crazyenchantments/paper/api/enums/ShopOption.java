...
public enum ShopOption {
    ...
    GKITZ("Name", "Lore", false, "GKitz", "<red><bold>GKitz", List.of(
            "<aqua>>><gray><u>Click to open<aqua><<"
    )),
    BLACKSMITH("Name", "Lore", false, "BlackSmith", "<gray><bold>The <aqua><bold>Black <blue><bold>Smith", List.of(
            "<aqua>>><gray><u>Click to open<aqua><<"
    )),
    TINKER("Name", "Lore", false, "Tinker", "<gray><bold>The <aqua><bold>Crazy <blue><bold>Tinkerer", List.of(
            "<aqua>>><gray><u>Click to open<aqua><<"
    )),
    ...
    PROTECTION_CRYSTAL("GUIName", "GUILore", true, "ProtectionCrystal", "<dark_purple><bold>Protection <aqua><bold>Crystal", List.of(
    ...
    SCRAMBLER("GUIName", "GUILore", true, "Scrambler", "<yellow><bold>The Grand Scrambler", List.of(
    ...
    SLOT_CRYSTAL("GUIName", "GUILore", true, "Slot_Crystal", "<dark_purple><bold>Slot <aqua><bold>Crystal", List.of(
            "<gray>A rare crystal that is said to",
