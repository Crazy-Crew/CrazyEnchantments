...
public class DataStorage {
	...
	public static void load() {
		...
		for(String kit : gkit.getConfigurationSection("GKitz").getKeys(false)) {
			...
			ItemStack displayItem = Methods.makeItem(gkit.getString("GKitz." + kit + ".Display.Item"), 1, gkit.getString("GKitz." + kit + ".Display.Name"), gkit.getStringList("GKitz." + kit + ".Display.Lore"), gkit.getBoolean("GKitz." + kit + ".Display.Glowing"));
